  ...
  <header class="site-header">
    <div class="container">
      <h1 class="school-logo-text float-left">
        <a href="<?php echo site_url() ?>"><strong>Duy</strong>Versity</a>
      </h1>
      ...
      <div class="site-header__menu group">
        ...
        <ul>
          <li <?php if (is_page('about-us')or wp_get_post_parent_id(get_the_ID(0) == 19)) 
...
<li <?php if (get_post_type() == 'program') echo 'class="current-menu-item"'; ?>>
  <a href="<?php echo get_post_type_archive_link('program'); ?>">Programs</a>
          ...
          <li <?php if (get_post_type() == 'event' OR is_page('past_events')
          ) echo 'class="current-menu-item"' ?>>
